...
//          /resume   → LandingPage (index inside ResumePage)
//          /resume/* → ResumePage handles all sub-routes
// UPDATED: 2026-06-27
...
import ResumePage from "./features/ResumePage";   // ✅ ResumePage handles /resume AND /resume/*
import DashboardPage from "./features/DashboardPage";
import RoadmapPage from "./features/RoadmapPage";
import LoginPage from "./Auth/LoginPage";
// ✅ FIX: LandingPage import REMOVED — it now lives inside ResumePage as the index route
            ...
            element={
              <div style={{
                ...
                <Routes>
                  ...
                  {/* ── Resume routes ─────────────────────────────────────────
                      ✅ FIX: ONE catch-all for the entire resume module.
                         /resume         → LandingPage  (index inside ResumePage)
                         /resume/new     → ResumeHomePage with create modal open
                         /resume/upload  → ResumeHomePage with upload modal open
                         /resume/editor/:id, /resume/analyze, /resume/templates
                         All handled by ResumePage's nested <Routes>.
                         The old separate <Route path="/resume"> that blocked
                         sub-route navigation is GONE.
                  ──────────────────────────────────────────────────────────── */}
